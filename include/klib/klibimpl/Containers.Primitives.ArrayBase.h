#ifndef KLIB_CONTAINERS_PRIMITIVES_ARRAYBASE_H
#define KLIB_CONTAINERS_PRIMITIVES_ARRAYBASE_H

#include "base.h"
#include "Containers.ArrayView.h"
#include "Containers.ContainerHelper.h"
#include "Containers.Primitives.ContainerBase.h"
#include "Ranges.IndexFromEnd.h"
...
namespace klib::Containers::Primitives
{
    ...
    template <class T>
    constexpr ArrayView<T> ArrayBase<T>::GetViewUnsafe(
        ssize_t offset
    ) const noexcept
    {
...
#endif //!KLIB_CONTAINERS_PRIMITIVES_ARRAYBASE_H
