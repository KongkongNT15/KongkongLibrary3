#ifndef KLIB_MEMORY_PRIMITIVES_GCHANDLETABLE_H
#define KLIB_MEMORY_PRIMITIVES_GCHANDLETABLE_H

#include "base.h"
#include "Containers.PagedList.h"
...
#endif //!KLIB_MEMORY_PRIMITIVES_GCHANDLETABLE_H
